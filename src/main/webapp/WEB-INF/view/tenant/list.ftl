...
<body class="body">
	...
	<div class="my-btn-box">
		...
		<span class="fr"> 
			...
			<div class="layui-input-inline">
				<input type="text" autocomplete="off" placeholder="请输入租户名" id="keyword" class="layui-input">
			</div>
	...
	<script type="text/javascript" src="${base}/static/js/app/tenant/tlist.js"></script>
</body>
</html>