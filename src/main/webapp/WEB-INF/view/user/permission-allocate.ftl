...
<html>
	...
	<body>
		<div style="margin: 15px;">
			...
			<form class="layui-form" action="${base}/admin/permission/allocateUserSave" method="post">
		...
		<script type="text/javascript" src="${base}/static/js/app/user/permission-acclocate.js"></script>
	</body>
</html>